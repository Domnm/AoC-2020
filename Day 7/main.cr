...
COLOR = "shiny gold"
contents = File.read_lines("bags_simple.txt")
...
needed_colors = [] of Contained_bag
top_bags.each do |top_bag|
	if top_bag.color_name == COLOR
		needed_colors = top_bag.bags_inside
	end
end
